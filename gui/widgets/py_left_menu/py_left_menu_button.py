...
class PyLeftMenuButton(QPushButton):
    ...
    def paintEvent(self, event):
        ...
        if self._is_active:
            ...
            # DRAW BG BLUE
            p.setBrush(QColor(self._context_color))
            p.drawRoundedRect(rect_blue, 8, 8)  # 파란색 줄 추가
